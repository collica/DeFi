...
beefy_avax_contracts = [
    ...
    '0xDc5e537764F5Ad0f51Bf52CCF0767083bb4565EC', #eth
    '0xD0e4b0B711A5296a8D72EB8B2a9Cb0F3f7A4211d' #btc
                ]
...
for x in beefy_bsc_contracts:
    ...
    balance = contract.functions.balanceOf(wallet).call() / float(10**decimals)
...
# arb_name_list = []
# arb_symbol_list = []
# arb_moo_balance_list = []
# arb_decimal_list = []
# arb_fpps_list = []
# arb_lp_qty_list = []
#
# for x in beefy_arb_contracts:
#     contract = arb_web3.eth.contract(address=Web3.toChecksumAddress(x), abi=beefy_arb_abi)
#     name = contract.functions.name().call()
#     symbol = contract.functions.symbol().call()
#     decimals = contract.functions.decimals().call()
#     balance = contract.functions.balanceOf(wallet).call() / float(10**decimals)
...
#     lps = balance * fpps
#
#     arb_chain_list.append('arb')
#     arb_name_list.append(name)
#     arb_symbol_list.append(symbol)
#     arb_decimal_list.append(decimals)
#     arb_moo_balance_list.append(balance)
#     arb_lp_qty_list.append(lps)
#
# arb_df = pd.DataFrame(list(zip(beefy_arb_contracts, arb_chain_list, arb_name_list, arb_symbol_list, arb_decimal_list, arb_moo_balance_list, arb_lp_qty_list)), columns=['Contract', 'Chain', 'Name', 'Symbol', 'Decimals', 'MooToken Qty', 'LP Qty'])
